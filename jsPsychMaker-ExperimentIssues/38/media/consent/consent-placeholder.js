...
switch (language) {
    ...
    case "Spanish":
        ...
        // Template variables
        var_title = `Experiment errors`;
        var_researcher_name = `Gorka Navarrete`;
        var_researcher_email = `gorkang@gmail.com`;
        var_researcher_affiliation = `Centro de Neurociencia Social y Cognitiva (CSCN)`;
    ...
    case "English":
        ...
        var_purpose = `To create a live example of how a jsPsychR survey and it's data preparation works`;
        var_procedure = `You will have to answer 2 or 3 questions about errors found in research protocols`;
        var_comprehension = `what types of errors are more common in our research`;

        intro_CONSENT = `
        <div title="logo"><p style="margin-bottom: 0.2in; line-height: 100%"><img src="` + path_logo + `" name="UAI" align="bottom" width="158" height="59" border="0"/></p></div>
        <div>
