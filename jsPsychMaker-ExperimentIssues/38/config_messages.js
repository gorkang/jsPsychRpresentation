...
switch (language) {
    ...
    case "Spanish":
        ...
        protocol_end = 'El estudio ha finalizado. Puedes cerrar esta página.';
    ...
    default:
        ...
        protocol_end = 'The study ended. You can close this page.';
            
        // INTRO [index.html] Screen where uid is entered
        intro_HTML = `<div title="logo"><p style="margin-bottom: 0.2in; line-height: 100%"><img src="` + logo_intro + `" name="UAI" align="bottom" width="200" height="44" border="0"/></p></div>
        This is a very brief survey about errors found in experimental protocols<BR><BR>
        If you have any doubts, you can write us to: <mailto::gorkang@gmail.com>gorkang@gmail.com</mailto><BR><BR>`;
        ...
        This is a very brief survey about errors found in experimental protocols<BR><BR>
        If you have any doubts, you can write us to: <mailto::gorkang@gmail.com>gorkang@gmail.com</mailto>`;
