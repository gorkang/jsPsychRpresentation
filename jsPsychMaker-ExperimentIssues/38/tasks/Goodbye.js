...
switch (language) {
    ...
    case "Spanish":
      ...
      button_label_next = 'Guardar respuestas';
      ...
      Goodbye_001_on_finish = 'El estudio ha finalizado. Puedes cerrar esta página.';
      break;
  
  
    case "English":
  
      button_label_next = 'Record answers';
      ...
      Goodbye_001_on_finish = 'The study ended. You can close this page.';
      break;
