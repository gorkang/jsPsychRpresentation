...
- Very easy to create new scales, and simple tasks, but complex experimental tasks <span style="color:red;">require javascript and HTML knowledge</span> (although there are a good number of examples available)
...
- No reviews unless data, stimuli and materials should be made publicly available ([www.opennessinitiative.org/](www.opennessinitiative.org/))
