...
- rigour of methodology and analysis  and overall paper quality 
...
<!-- ![](img/RRs.png){width=300, height=300, fig-align="right"} -->
:::

::::


## How RRs work {background-image="img/RRs.webp" background-size="50%" background-position="bottom"}
...
- Multiple implementations of the same tasks in different technologies, not always exact replicas, not always easy to find.
...
![](img/euphoria.webp){width=40% fig-align="center"}
